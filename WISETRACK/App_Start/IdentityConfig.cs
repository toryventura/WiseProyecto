...
namespace WISETRACK
{
	public class EmailService : IIdentityMessageService
	{
		...
		private Task configSendGridasync(IdentityMessage message)
		{
			...
			Email from = new Email("gabriel.mamani@e-tech.com.bo");
	...
	public class ApplicationUserManager : UserManager<ApplicationUser>
	{
		...
		public bool ClearAllUserRoles(string userId)
		{
			foreach (var item in this.GetRoles(userId))
			{
				if (!this.RemoveFromRole(userId, item).Succeeded)
				{
					return false;
				}
			}
