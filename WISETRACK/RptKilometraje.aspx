<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="RptKilometraje.aspx.cs" Inherits="WISETRACK.RptKilometraje" %>
        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">Reporte de Kilometraje</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                <telerik:RadComboBox ID="rcbTipoRel" runat="server" DropDownCssClass="dropdown" AllowCustomText="false"
                                    EmptyMessage="" Width="160px" CssClass="dropdown" Style="font-size: small">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="IGUAL A" />
                                        <telerik:RadComboBoxItem Value="1" Text="MAYOR A" />
                                        <telerik:RadComboBoxItem Value="2" Selected="true" Text="MAYOR O IGUAL A" />
                                    </Items>
                                </telerik:RadComboBox>
                            </div>
                            <div class="form-group">
