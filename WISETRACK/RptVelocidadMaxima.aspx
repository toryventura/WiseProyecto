<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="RptVelocidadMaxima.aspx.cs" Inherits="WISETRACK.RptVelocidadMaxima" %>
        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">Reporte de Velocidad Máxima</div>
                    ...
                    <div class="panel-body" style="height: 100%">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                <asp:Label ID="lblVelocidad" runat="server" Text="<b>Velocidad (Km/h)</b>" Font-Size="Small"></asp:Label>
                            </div>
                        </div>
                        <div class="form-inline">
                            <div class="form-group">
                                <asp:DropDownList ID="rcbTipoRel" runat="server">
                                </asp:DropDownList>
                                <%--aqui tiene que modificarse--%>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="txbVelocidad" runat="server" Font-Size="Small" Width="70px" CssClass="form-control" Text="50" TextMode="Number"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-inline">
                            <div class="form-group" style="width: 100%; height: 155px; overflow-y: auto">
                                ...
                                <div class="col-sm-9 table-responsive" style="padding-left: 0px; margin-left: 5%; width: 92%; margin-right: 3%; padding-right: 0px; right: 0%; top: 0px;">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" style="width: 100%; height: 398px; overflow-y: auto">
                            <asp:UpdatePanel ID="upresultado" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="gdvVelocidadesMax" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvVelocidadesMax_RowCommand"
