<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="RptDetencionesant.aspx.cs" Inherits="WISETRACK.RptDetenciones" %>
            ...
            <div class="span3">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <telerik:RadComboBox ID="cboplaca" runat="server" AllowCustomText="true" OnItemDataBound="cboplaca_ItemDataBound" CheckBoxes="true"
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" style="width: 100%; height: 398px; overflow-y: auto">
                            ...
                            <ContentTemplate>
                            <asp:GridView ID="gdvDetenciones" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvDetenciones_RowCommand"
