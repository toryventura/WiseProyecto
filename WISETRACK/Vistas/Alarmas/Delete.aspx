<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="WISETRACK.Vistas.Alarmas.Delete" %>
        ...
        <div class="row-fluid">
            ...
            <div class="table-responsive table-condensed table-hover table">
                <dl class="dl-horizontal">
                    ...
                    <dt id="dtTiempo" runat="server">Tiempo Máximo (
                    ...
                    <dt>Tiempo de Envio (Alerta continua)</dt>
                    <dd>
