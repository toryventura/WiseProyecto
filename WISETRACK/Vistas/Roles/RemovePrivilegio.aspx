<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="RemovePrivilegio.aspx.cs" Inherits="WISETRACK.Vistas.Roles.RemovePrivilegio" %>
    ...
    <div class="container">
        <div class="row">
            <div class="form-group" >
                <h2><b>Quitar Privilegio (<% =Request.QueryString["rol"] %>)</b></h2>
                <p class="alert-info">
            ...
            <div class="form-group">
                <asp:Button runat="server" ID="btnGuardar" OnClick="btnGuardar_Click" Text="Guardar" CssClass="btn btn-primary btn-sm"/>
            </div>
        </div>
    </div>
</asp:Content>
